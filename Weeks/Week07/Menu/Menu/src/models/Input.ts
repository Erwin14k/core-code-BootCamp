...
export class Input {
    ...
    static async getForm(message: string,choices: Choices): Promise<UserFormInput> {
    ...
    static async getSelect(message: string,choices: SelectChoices): Promise<UserOption> {
    ...
    static async getSelectById(message: string,choices: Choice[]): Promise<UserOptionById> {
